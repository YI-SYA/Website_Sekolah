...
{{$siswa->mapel->count()}} <span>Mata Pelajaran</span>
 ...
 <div class="text-center"><a href="/siswa" class="btn btn-secondary">Back</a><a href="/siswa/{{$siswa->id}}/edit" class="btn btn-primary">EditProfile</a></div>
 </div>
 <!-- END PROFILE DETAIL -->
 </div>
 <!-- END LEFT COLUMN -->
